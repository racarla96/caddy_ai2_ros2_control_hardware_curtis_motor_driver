...
public:
    ...
    std::chrono::system_clock::time_point get_last_update_0x226_frame() const { return last_update_0x226_frame_; }
    std::chrono::system_clock::time_point get_last_update_0x227_frame() const { return last_update_0x227_frame_; }
    std::chrono::system_clock::time_point get_last_update_0x327_frame() const { return last_update_0x327_frame_; }
    std::chrono::system_clock::time_point get_last_update_0x1A6_frame() const { return last_update_0x1A6_frame_; }
    std::chrono::system_clock::time_point get_last_update_0x2A6_frame() const { return last_update_0x2A6_frame_; }
    std::chrono::system_clock::time_point get_last_update_0x726_frame() const { return last_update_0x726_frame_; }
